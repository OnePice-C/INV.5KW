...
//! \param inputPtr1 Pointer to data being buffered in the first buffer
//! \param inputPtr2 Pointer to data being buffered in the second buffer
//! \param inputPtr3 Pointer to data being buffered in the third buffer
//! \param inputPtr4 Pointer to data being buffered in the fourth buffer
//! \param outputPtr1 Pointer to where first array of buffered data is stored
//! \param outputPtr2 Pointer to where second array of buffered data is stored
//! \param outputPtr3 Pointer to where third array of buffered data is stored
//! \param outputPtr4 Pointer to where fourth array of buffered data is stored
